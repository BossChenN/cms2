...
public class StringUtil {
	...
	public static boolean hasText(String src) {
		if (src == null || "".equals(src.trim()) || src.trim().length() == 0) {
			return false;
		} else {
			return true;
		}
	...
	public static String randomChineseString(int length) {
		...
		for (int i = 0; i < length; i++) {
			Random r = new Random();
			int high = Math.abs(176 + r.nextInt(71));
			r = new Random();
			int low = Math.abs(161 + r.nextInt(94));
	...
	public static String generateChineseName() {
		...
		// 用来存储姓名
		StringBuffer stringBuffer = new StringBuffer();
		stringBuffer.append(arr[nextInt]);
		random = new Random();
		int nextInt2 = random.nextInt(3);
		while(nextInt2 == 0){
			nextInt2 = random.nextInt(3);
		}
		String randomChineseString = randomChineseString(nextInt2);
